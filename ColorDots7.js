...
// const injectionTarget = document.querySelector(".swagger-container") || document.querySelector("#swagger-ui")
const injectionTarget = document.querySelectorAll("#swagger-ui")[0].firstChild || document.querySelectorAll("#swagger-ui")[0].firstElementChild
setTimeout(() => { 
  (function(){
 for (let i = 0; i < 20; i++) {
